...
![](img/2022-7-3Android系统编译_1.jpg)

## 3 编译流程
### 3.1 编译目录
Android的编译目录在/build 中，看一下Android 10源码中的build目录，现在是这个样子：

![](img/2022-7-3Android系统编译_2.jpg)
...
![](img/2022-7-3Android系统编译_3.jpg)

### 3.3 soong 编译过程
  soong的编译过程如下图所示：

![](img/2022-7-3Android系统编译_4.jpg)
...
![](img/2022-7-3Android系统编译_5.jpg)

### 4.1 编译环境初始化
#### 4.1.1 envsetup
envsetup.sh 主要做了下面几个事情：

![](img/2022-7-3Android系统编译_6.jpg)
